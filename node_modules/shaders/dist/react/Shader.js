	...
	const startTelemetryWhenReady = () => {
		const checkRendering = () => {
			...
			if (rendererRef.current.getPerformanceStats().fps > 0) {
				telemetryCollectorRef.current = startTelemetry(rendererRef.current, "2.5.128", disableTelemetry, isPreview);
