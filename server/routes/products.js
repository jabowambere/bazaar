...
router.post('/', protect, upload.single('productimage'), async (req, res) => {
  try {
    ...
    _io?.broadcastActivity(req.user._id.toString(), 'productActivity', { action: 'added', productName: saved.productname, by: req.user.name });
...
router.put('/:id', protect, upload.single('productimage'), async (req, res) => {
  try {
    ...
    _io?.broadcastActivity(req.user._id.toString(), 'productActivity', { action: 'updated', productName: updated.productname, by: req.user.name });
...
router.delete('/:id', protect, async (req, res) => {
  try {
    ...
    _io?.broadcastActivity(req.user._id.toString(), 'productActivity', { action: 'deleted', productName: product.productname, by: req.user.name });
